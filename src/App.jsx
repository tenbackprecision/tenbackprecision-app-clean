...
if (activeView === "performance") {
  return (
    <PerformancePage
      ...
      addSeriesRef={addSeriesRef}
      showEquipmentManager={showEquipmentManager}
      setShowEquipmentManager={setShowEquipmentManager}
      equipmentForm={equipmentForm}
      setEquipmentForm={setEquipmentForm}
      saveEquipment={saveEquipment}
      editingEquipmentId={editingEquipmentId}
      setEditingEquipmentId={setEditingEquipmentId}
      emptyEquipmentForm={emptyEquipmentForm}
      showBowlrImport={showBowlrImport}
      setShowBowlrImport={setShowBowlrImport}
      bowlrImportRef={bowlrImportRef}
      handleBowlrImportFile={handleBowlrImportFile}
      bowlrPreview={bowlrPreview}
      importBowlrGames={importBowlrGames}
      deleteImportedBowlrGames={deleteImportedBowlrGames}
      filteredSeries={filteredSeries}
