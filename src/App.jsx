...
function handleImportFile(file) {
  ...
  const isFoldableWide = screenWidth >= 700 && screenWidth < 1100;
  const mobileStack = isPhone;
...
function exportTaxSummaryCsv() {
  ...
  const appStyles = {
    background:
      "radial-gradient(circle at center top, rgba(52, 120, 255, 0.25), rgba(7, 16, 45, 0.95) 52%, rgba(2, 8, 23, 1) 100%)",
    card: cardStyle,
    text: "#e5f0ff",
    muted: "#b8caef",
    accent: "#ff8e72",
  ...
  function StatCard({ label, value, subValue, valueColor }) {
    return (
      <div style={appStyles.card}>
        ...
        <div style={{ color: valueColor || appStyles.text, fontSize: 28, fontWeight: 800 }}>
          {value}
        </div>
        {subValue ? (
          <div style={{ color: appStyles.muted, marginTop: 6, fontSize: 13 }}>{subValue}</div>
        ) : null}
      </div>
    );
  }
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            <button
              ...
              style={{
                ...buttonStyle,
                background:
                  activeView === "dashboard" ? appStyles.accent : "rgba(255,255,255,0.12)",
              }}
            >
              Dashboard
            </button>
            <button
              ...
              style={{
                ...buttonStyle,
                background:
                  activeView === "receipts" ? appStyles.accent : "rgba(255,255,255,0.12)",
              }}
            >
              Receipts
            </button>
          ...
          <>
            ...
            >
              <div style={appStyles.card}>
                <SectionTitle
                  title="Monthly Trend"
                  subtitle="Income, expenses, and profit across the calendar."
                />
              ...
              <div style={appStyles.card}>
                <SectionTitle
                  ...
                  subtitle="Where your bowling dollars are sprinting off to."
                />
                <div style={{ width: "100%", height: 320 }}>
                  <ResponsiveContainer>
                    <PieChart>
            ...
            >
              <div style={appStyles.card}>
                <SectionTitle
                  ...
                  subtitle="Receipt-ready expense entry."
                />
...
/>
              ...
              <div style={appStyles.card}>
                <SectionTitle
                  ...
                  subtitle="Track winnings, payouts, and side money."
                />
                <div style={{ display: "grid", gap: 10 }}>
                  <input
                    type="date"
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setIncomeForm((prev) => ({ ...prev, note: e.target.value }))
                    }
                    style={fieldStyle}
                  />
                  <div
            ...
            >
              <div style={appStyles.card}>
                ...
                {recentActivity.length === 0 ? (
                  <div style={{ color: appStyles.muted, textAlign: "center" }}>
                    No activity yet. Feed the beast some data.
                  </div>
                ) : (
                  <div style={{ display: "grid", gap: 10 }}>
                    {recentActivity.map((item) => (
                      ...
                      >
                        <div>
                          ...
                          {item.note ? (
                            <div style={{ color: appStyles.muted, fontSize: 13, marginTop: 4 }}>
                              {item.note}
                            </div>
                          ) : null}
                        </div>
                        <div
                          style={{
                            fontWeight: 800,
                            color: item.amount >= 0 ? appStyles.good : appStyles.bad,
                          }}
                        >
                          {item.amount >= 0 ? "+" : "-"}
              ...
              <div style={appStyles.card}>
                ...
                {receipts.length === 0 ? (
                  <div style={{ color: appStyles.muted, textAlign: "center" }}>
                    No receipts yet. Upload one and this section wakes right up.
                  </div>
                ) : (
                  <div style={{ display: "grid", gap: 10 }}>
          ...
          <div style={appStyles.card}>
            <SectionTitle
              ...
              subtitle="Every receipt-backed expense in one place."
            />
            {receipts.length === 0 ? (
              <div style={{ color: appStyles.muted, textAlign: "center" }}>
                No receipts uploaded yet. Add one from the expense form above.
              </div>
            ) : (
              <div
                style={{
        ...
        <div style={{ ...appStyles.card, marginTop: 18 }}>
          <SectionTitle
            ...
            subtitle="Edit or delete entries without hunting through Firestore."
          />
          <div
            style={{
              display: "grid",
            ...
            <div>
              ...
              <div style={{ display: "grid", gap: 10 }}>
                {filteredExpenses.slice(0, 8).map((item) => (
                  <div
                    key={item.id}
                    style={{ padding: 12, borderRadius: 14, background: "rgba(255,255,255,0.06)" }}
                  >
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() => removeExpense(item)}
                        style={{ ...buttonStyle, background: appStyles.bad, padding: "10px 14px" }}
                      >
                        Delete
                      </button>
                    </div>
        ...
        >
          <div style={{ maxWidth: "92vw", maxHeight: "92vh" }}>
            <img
              src={selectedReceipt}
              alt="Full receipt"
              style={{ maxWidth: "100%", maxHeight: "84vh", borderRadius: 16 }}
            />
            <div style={{ color: "#d7e6ff", textAlign: "center", marginTop: 10 }}>
      ...
      {dataLoading ? (
        ...
        >
          <div style={{ ...appStyles.card, fontWeight: 800 }}>
            Loading your bowling business HQ…
          </div>
        </div>
      ) : null}
    </div>
